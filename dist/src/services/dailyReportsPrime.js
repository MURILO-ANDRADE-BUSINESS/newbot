...
exports.dailyReportsPrime = void 0;
/* eslint-disable no-plusplus */
/* eslint-disable no-restricted-syntax */
const betsService_1 = require("./betsService");
const botConfig_1 = require("./botConfig");
const dailyMonthReport_1 = require("./dailyMonthReport");
function dailyReportsPrime(events, bot) {
...
✖️ Sem gol: ${reds} jogos`;
        yield bot.sendMessage(botConfig_1.botConfig.charPrime, message);
        yield (0, betsService_1.saveDailyReportPrime)(greens, reds, greens + reds);
        yield (0, dailyMonthReport_1.dailyMonthReport)(bot);
    });
}
exports.dailyReportsPrime = dailyReportsPrime;
