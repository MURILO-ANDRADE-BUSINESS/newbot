...
class EventsRepository {
    ...
    constructor() {
        this.repository = app_data_source_dev_1.myDataSource.getRepository(Event_1.Event);
    }
    getEventFromDB(id) {
    ...
    unfinishedEventsFilter(upperLimit, lowerLimit) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield this.repository.find({
                where: [
                    {
                        time: (0, typeorm_1.Between)(lowerLimit, upperLimit),
                        isFinished: false,
                    },
                    {
                        time: (0, typeorm_1.Between)(lowerLimit, upperLimit),
    ...
    EventsBetweenDatesFilter(upperLimit, lowerLimit) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield this.repository.find({
                where: [
                    {
